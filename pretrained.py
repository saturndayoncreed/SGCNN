...
with open(test_file, 'r') as file:
    ...
    for i in range(len(lines)):
        ...
        test_materials.append(
            str_list[0] + '-' + str_list[1] + '-' + str_list[2] + '-' + str_list[3] + '-' + str_list[4] + '-' +
            str_list[5])
...
Wl_1 = tf.Variable(tf.random_normal([2 * CATEGORY_NUM, hidden_node], stddev=initial_std),
                   name='Fully_Connected_weight1')
...
(test_bulk_num, test_atom_b, test_bond_b, test_bond_index1_b, test_bond_index2_b, test_atom_num_b, test_bond_num_b,
 test_surface_num, test_atom_s, test_bond_s, test_bond_index1_s, test_bond_index2_s, test_atom_num_s, test_bond_num_s) \
    = data_preparation(test_materials)
...
with tf.Session() as sess:
    ...
    feed_dict_test = {atom_num_b: test_bulk_num,
                      atom_num_s: test_surface_num,
                      atoms_b: test_atom_b,
                      bonds_b: test_bond_b,
                      atom_number_b: test_atom_num_b,
                      bond_number_b: test_bond_num_b,
                      bonds_b_index1: test_bond_index1_b,
                      bonds_b_index2: test_bond_index2_b,
                      atoms_s: test_atom_s,
                      bonds_s: test_bond_s,
                      atom_number_s: test_atom_num_s,
                      bond_number_s: test_bond_num_s,
                      bonds_s_index1: test_bond_index1_s,
                      bonds_s_index2: test_bond_index2_s,
                      y: test_y,
                      keep_prob: 1.0, }
